from Temod.core.base.attribute import StringAttribute
...
class AccessRight(Entity):
	...
	def __init__(self, label, **kwargs):
		super(AccessRight, self).__init__(
			StringAttribute("label",value=label,force_lower_case=False,is_nullable=False,non_empty=True)
		)
		self.infos = kwargs
	...
	def __getattribute__(self,attr):
		try:
			...
			pass
		return super(AccessRight,self).__getattribute__(attr)
